...
player_miner = None
player_is_ship = True
asteroid_one = Asteroid(random.randrange(100, screen_width-100), random.randrange(100, screen_height-100), "MapTiles/AstDebris03.png")
asteroid_two = Asteroid(random.randrange(100, screen_width-100), random.randrange(100, screen_height-100), "MapTiles/AstDebris03.png")
asteroid_three = Asteroid(random.randrange(100, screen_width-100), random.randrange(100, screen_height-100), "MapTiles/AstDebris03.png")
